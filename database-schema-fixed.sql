...
-- ===========================================
-- PHASE 8: ROW LEVEL SECURITY (FIXED FOR SIGNUP)
-- ===========================================
...
-- ===========================================
-- TENANTS POLICIES (Allow signup)
-- ===========================================
-- Allow authenticated users to INSERT new tenants (for signup)
CREATE POLICY tenants_insert ON tenants
  FOR INSERT
  WITH CHECK (auth.uid() IS NOT NULL);

-- After signup, users can only see/modify their own tenant
...
-- After signup, users can see users in their tenant
